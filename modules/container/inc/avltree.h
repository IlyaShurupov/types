...
public:
	...
	AVLNode<Key, avl_policy>* max_node(AVLNode<Key, avl_policy>* head) {
		if (head) {
	...
	AVLNode<Key, avl_policy>* min_node(AVLNode<Key, avl_policy>* head) {
		if (head) {
	...
	AVLNode<Key, avl_policy>* invalid_tree(AVLNode<Key, avl_policy>* head) {
